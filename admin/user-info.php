    ...
    <header class="fixed right-0 left-0 px-4 py-3 bg-slate-800 block z-50">
        <section class="flex items-center justify-between">
            ...
            <nav class="navbar">
                ...
                <a href="admin.html"
                    class="text-lg px-2 py-1 ml-1 hover:underline hover:underline-offset-4 hover:decoration-2 text-slate-400 font-normal hover:decoration-yellow-600 hover:text-yellow-600">Login</a>
            </nav>
